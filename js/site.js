(() => {
  ...
  const architectureData = {
    ...
    compute: {
      ...
      text: "Camera, microcomputer, modem, router, power, heating, and enclosure components had to operate as one field-ready unit. Procurement and integration dependencies were tracked as delivery risks rather than isolated engineering tasks.",
    },
    alert: {
      title: "Driver-warning output",
      text: "The system translated a verified pedestrian event into a visible warning state. Acceptance required defined trigger behaviour, response timing, fail states, and test evidence.",
    },
    monitor: {
